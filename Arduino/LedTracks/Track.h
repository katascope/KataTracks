...
*/  
  ...
  100000, fx_strip_all,
  100000, fx_transition_timed_fade,
  100000, fx_palette_dark,
  101000, fx_speed_rst,
  101000, fx_strip + (LEDS_4|LEDS_5),//arms
  101000, fx_transition_timed_wipe_pos,
  101000, fx_palette_magenta,

  102000, fx_speed_rst,
  102000, fx_strip + (LEDS_0|LEDS_1|LEDS_2|LEDS_3),//chest
  102000, fx_transition_timed_wipe_neg,
  102000, fx_palette_magenta,
    
  103000, fx_speed_rst,
  103000, fx_strip + (LEDS_6|LEDS_7),//legs
  103000, fx_transition_timed_wipe_neg,
  103000, fx_palette_magenta,
